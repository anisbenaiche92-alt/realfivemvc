...
router.get('/event-requests', adminController.getEventRequests);
router.put('/event-requests/:id', adminController.updateEventRequestStatus);
router.delete('/event-requests/:id', adminController.deleteEventRequest);
